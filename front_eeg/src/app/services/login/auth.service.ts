...
export class AuthService {
  private loginUrl = 'http://35.194.61.214:5000/login';
  private forgotPasswordUrl = 'http://35.194.61.214:5000/solicitar_cambio_contraseña';
  private currentUserUrl = 'http://35.194.61.214:5000/usuario/actual';
  private resetPasswordUrl = 'http://35.194.61.214:5000/resetear_contrasena'; // Nueva URL para restablecer contraseña
